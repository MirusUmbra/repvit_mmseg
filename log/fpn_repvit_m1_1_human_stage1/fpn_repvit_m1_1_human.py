...
log_level = 'INFO'
load_from = None
resume_from = 'log/fpn_repvit_m1_1_human_stage1/latest.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone',
            checkpoint='log/fpn_repvit_m1_1_human_stage1/latest.pth'),
...
work_dir = 'log/fpn_repvit_m1_1_human_stage1'
