...
class RepViT(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.init_cfg is None or pretrained is None:
    ...
    #         if checkpoint is None and isinstance(self.init_cfg, dict):
    #             checkpoint = self.init_cfg.get('checkpoint', None)

    #         if isinstance(checkpoint, str):
    #             ckpt_path = checkpoint
    #         else:
    #             raise TypeError(f'`init_cfg.checkpoint` must be a string path, but got {type(checkpoint)}')
    #     elif isinstance(pretrained, str):
    #         ckpt_path = pretrained
    #     else:
    #         raise TypeError(f'`pretrained` must be a string path or None, but got {type(pretrained)}')
